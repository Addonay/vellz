...
//!   and non-empty variation coordinates are explicit `error.Unsupported`; a
//!   run whose transform would require hinting is rejected up front instead of
//!   silently rendering unhinted.
