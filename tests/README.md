...
All scenes above render byte-exact with `zig build corpus` (103/103,
`tolerance=0`: 32 quality/f32 + 16 speed/u8 + 22 outline glyph + 6 decoration
+ 27 COLR). The
...
Planned: bitmap (CBDT/CBLC/sbix) glyphs, mixed scripts, resource exhaustion,
repeated resize.
